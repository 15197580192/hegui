...
import com.hzy.finance.OCR.JSONToExcelUtil;
 ...
 * @author Hu Zheyuan
 * @description: 测试OCR
 * @date: Created in 19:44 2023/1/29
 * @version: 1.0
 */
public class TestOCR {

  String getFileContentAsBase64(String path) throws IOException {
  ...
  public void test1() throws IOException {
    String filePath = "G:\\Desktop\\电网\\hegui\\tests\\下载发票.png";
    System.out.println(getFileContentAsBase64(filePath));
  }
  ...
  public void test() throws JSONException, IOException {
    ...
    // 检验发票金额
    // if (!mObject.priceCheck()) {
    //   System.out.println("发票金额有误，请核对发票");
    // } else {
    //   System.out.println("发票金额正确");
    // }

    // 转excel
    // JSONToExcelUtil.toExcelByString(parseOCRResult, savePath, excelName);
